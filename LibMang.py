...
class Member:
    ...
    def modify(self,Nm,Ad,DB,Mob):
        ...
        self.MDOB=DB if DB else self.DOB
...
def LibMang():
    print '*'*79
    print ('*'*5+" WELCOME TO SHERLOCK'S LIBRARY "+'*'*5).center(79)
    print '-'*79
...
def Books_Display(bkl):
    sz=(4,16,12,10,4,4,4,10,3,3)
    hd=("Acc No","Title","Author","Publisher","Prce(Rs)","Edition","Pages","Date of Purchase","Issued","Active")    
